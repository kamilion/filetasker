#!/bin/bash
# -----------
# FileTasker Task for ASDI Legacy
# -----------
# CMDLine Inputs: NIL
# -----------
...
# Filename Inputs:
# No Extension
#  asdi_Data.200903010000
# -----------
# Filename Outputs:
# TXT.GZ
#  asdi_data.200903010000.txt
# -----------
...
task()
{
  ...
  ar_file_name[0]="asdi_data"  # Removes the _xml designation
  ar_file_name=( "${ar_file_name[@]}" ) # Adds proper extensions
...
then
    ...
    echo "   FileTasker ASDI Legacy Operations Module ${ftask_version} Loaded at ${SECONDS} seconds."
fi
